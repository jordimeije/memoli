...
import { ShoppingCart, X, Plus, Minus, Clock, MapPin, Phone, ChevronDown, Star, Check } from "lucide-react";
...
const IMG = (f: string) =>
  asset(`images/items/${f.endsWith(".jpg") ? f.replace(/\.jpg$/, ".webp") : f}`);
    ...
    <div className="min-h-screen bg-[#120800] text-[#F5EDD6] font-['Inter'] relative overflow-x-hidden">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${navScrolled ? "bg-[#1A0A00]/95 backdrop-blur-md shadow-lg shadow-black/50" : "bg-transparent"}`}>
        <nav className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 flex-shrink-0">
            <img
              src={asset("images/memoli-logo.png")}
              alt="Memoli Kebab"
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-full md:w-1/2">
          <img src={asset("images/hero-doener.jpg")} alt="Vers bereide döner bij Memoli" className="w-full h-full object-cover" />
      ...
      <section id="over-ons" className="bg-[#1A0A00] border-t border-[#2D1500]">
        <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            <img src={asset("images/about-interior.jpg")} alt="Interieur Memoli Hengelo" className="col-span-2 h-56 w-full object-cover rounded-2xl" />
            <img src={asset("images/about-ingredients.jpg")} alt="Verse ingrediënten" className="h-40 w-full object-cover rounded-2xl" />
            <img src={asset("images/about-wrap.jpg")} alt="Dürüm wrap" className="h-40 w-full object-cover rounded-2xl" />
          </div>
        </div>
      </section>
      ...
      <footer id="contact" className="bg-[#0A0400] border-t border-[#1A0A00]">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row justify-between gap-8">
            <div>
              <div className="flex items-center gap-2 mb-3"><img src={asset("images/memoli-logo.png")} alt="Memoli Kebab" className="h-7 w-7 rounded-full object-contain" /><span className="font-['Playfair_Display'] text-xl font-bold text-white">Memoli</span></div>
